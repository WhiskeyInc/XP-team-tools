...
public class UIObserverStrategyAuth extends JFrame {
	...
	private final ChatUIObserverStrategyAuth chatUI;
	private final TimerUIObserverStrategy timerUI;

	public UIObserverStrategyAuth(IClientService setMessage,
			IClientService setTimeStamp, StrategyClientAuth client) {
		super();

		this.chatUI = new ChatUIObserverStrategyAuth(setMessage, client);
	...
	public ChatUIObserverStrategyAuth getChatUI() {
		return chatUI;
	}
