 ...
 *
 */
public class ChatUIObserverStrategy extends JPanel implements Observer{
	...
	public ChatUIObserverStrategy(IClientService clientService, StrategyClient client) {
		this.client = client;
