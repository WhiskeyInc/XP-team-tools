...
/**
 * The UI of the chat, it extends JPanel
 * @author alberto
 *
 */
public class ChatUIObserverStrategyAuth extends JPanel implements Observer{
	...
	private StrategyClientAuth client;
	private IClientService clientService;
	
	public ChatUIObserverStrategyAuth(IClientService clientService, StrategyClientAuth client) {
		this.client = client;
